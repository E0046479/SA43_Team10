...
<body>
	<div class="panel panel-default">
		<div class="panel-heading">Student Performance List</div>
		<div class="panel-body">
			<table class="table table-striped table-bordered">
				...
				<c:forEach var="list" items="${studentPerformanceList}" varStatus="status">
                <tr class="${status.index%2==0?'even':'odd'}">
                    ...
                    <td class="nowrap">
                        <c:url var="updurl" scope="page" value="/individualStudentPerformance">
                            <c:param name="userId" value="${list.studentDTO.studentId}"/>                            
                        </c:url>
                        <a href="${updurl}">View</a>
                        &nbsp;&nbsp;&nbsp;                       
                    </td>
                </tr>
            </c:forEach>
