			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-md-5 col-sm-5 col-xs-5">
						<input class="form-control input-md" id="cID" size=15 name="courseName" 
						type="text" maxlength=20 required="true" />
							    <input type="hidden" name="courseId" value="true" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-4 col-xs-4 control-label text-right"
					...
					<div class="col-md-5 col-sm-5 col-xs-5">
						<input class="form-control input-md" id="lID" name="lecturerId" type="text"  maxlength=20 required="true">
				...
				<div class="form-group">
					...
					<div class="col-md-5 col-sm-5 col-xs-5">
						<textarea class="form-control input-md" id="cDesc" rows="6" name="courseDescription" type="text"
				...
				<div class="form-group">
					...
					<div class="col-md-5 col-sm-5 col-xs-5">
						<input class="form-control input-md" id="cDesc" name="courseType" type="text" maxlength=20 required="true">
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-4 col-xs-4 control-label text-right"
					...
					<div class="col-md-5 col-sm-5 col-xs-5">
						...
						min="1" max="100" required="true" title="Duration must be less or equal to 100 days"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-4 col-xs-4 control-label text-right"
					...
					<div class="col-md-5 col-sm-5 col-xs-5">
						<input class="form-control input-md" id=enrollmentDate name="courseStartDate" type="text" maxlength=20 required="true">
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-4 col-xs-4 control-label text-right"
				...
				<div class="form-group">
					...
					<div class="col-md-5 col-sm-5 col-xs-5">
						...
						min="4" max="12" required="true" title="Credit range : 4 - 12"/>
					</div>
				</div>
				<div class="">
