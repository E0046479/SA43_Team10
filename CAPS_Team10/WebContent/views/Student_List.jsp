...
<body>
	<div class="panel panel-default">
		<div class="panel-heading"><fmt:message key="label.studentListJsp.title"/></div>
        ...
        <table class="borderAll">
            <tr>
               <th>#</th>
                ...
                <th><fmt:message key="label.student.table.title.studentEmail"/></th>
                 <th><fmt:message key="label.student.table.title.enrolmentDate"/></th>
                <th><fmt:message key="label.student.edit"/> <fmt:message key="label.student.delete"/></th>
            </tr>
            <c:forEach var="student" items="${studentList}" varStatus="status">
                <tr class="${status.index%2==0?'even':'odd'}">
                    ...
                    <td class="nowrap">
                        <c:url var="updurl" scope="page" value="/StudentEdit.jsp">
                        ...
                        <a href="${updurl}"><fmt:message key="label.student.edit"/></a>
                        &nbsp;&nbsp;&nbsp;
                        <c:url var="delurl" scope="page" value="/deleteStudent">
                            <c:param name="name" value="${student.studentName}"/>
                        </c:url>
                        <a href="${delurl}"><fmt:message key="label.student.delete"/></a>
                    </td>
                </tr>
            </c:forEach>
        </table>
